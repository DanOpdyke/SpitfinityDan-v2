...
/// <summary>
/// The Garen Info script provides simple information pertaining to the Garen character class,
/// as well as button navigation for starting a game.
/// </summary>
public class GarenInfoScript : MonoBehaviour {
	public Texture aTexture;  		  //Garen's Info Screen

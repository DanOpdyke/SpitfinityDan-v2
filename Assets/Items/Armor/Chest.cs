...
public class Chest : MonoBehaviour, Item, Armor {

	private Texture2D texture;
	private int numTextures = 10;
	...
	public void randomizeArmor(int level){
		...
		name = "Generic Chest";
		texture = Resources.Load("ChestTextures/texture" + Random.Range(0, numTextures)) as Texture2D;

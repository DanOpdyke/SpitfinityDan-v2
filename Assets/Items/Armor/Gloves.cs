...
public class Gloves : MonoBehaviour, Item, Armor {

private Texture2D texture;
	private int numTextures = 4;
	...
	public void randomizeArmor(int level){
		...
		name = "Generic Gloves";
		texture = Resources.Load("GlovesTextures/texture" + Random.Range(0, numTextures)) as Texture2D;
